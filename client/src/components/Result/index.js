        ...
        return (
            ...
            <div className="card mb-3" key={this.props.animal.id}>
                <div className="row">
                    ...
                    <div class="col s6">  
                        <img atl={this.props.animal.name} className="img-fluid" style={{width: 300, height:300}} src={ this.props.animal.primary_photo_cropped ?
                    ...
                    <div class="col s6">
                        <div className="card-body">
                            ...
                            <div>
                                <a href={this.props.animal.url} className="btn orange lighten-1 z-depth-0" >View</a>
